...
func (i *AtomicUint32) Next() uint32            { return atomic.AddUint32((*uint32)(i), 1) }
func (i *AtomicUint32) Prev() uint32            { return atomic.AddUint32((*uint32)(i), ^uint32(0)) }
func (i *AtomicUint32) Load() uint32            { return atomic.LoadUint32((*uint32)(i)) }
func (i *AtomicUint32) Store(j uint32)          { atomic.StoreUint32((*uint32)(i), j) }
func (i *AtomicUint32) Add(delta uint32) uint32 { return atomic.AddUint32((*uint32)(i), delta) }
func (i *AtomicUint32) Subtract(delta uint32) uint32 {
	return atomic.AddUint32((*uint32)(i), ^(delta - 1))
}
func (i *AtomicUint32) UnmarshalXMLAttr(attr xml.Attr) error {
